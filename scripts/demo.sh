...
step "15/21 · Fase 10 — Remote Control (gateway, pareamento, mensagem governada)"
...
step "16/21 · Fase 11 — Integrações (conector declarado, chamada governada)"
...
step "17/21 · Fase 12 — Packs verticais (catálogo, proposta, instalação)"
...
step "18/21 · Fase 12 — Fila de saída (promessa, espera crescente, desistência)"
...
step "19/21 · Lacuna 10b — anexos entram governados, botões viram comando"
...
step "20/21 · Lacuna 12b — worker da fila e atualização de pack"
...
step "21/21 · auditoria e memória"

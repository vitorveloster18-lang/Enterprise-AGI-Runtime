...
_VIEWER = {TASK_READ, POLICY_READ, AGENT_READ, APPROVAL_READ, MEMORY_READ, AUDIT_READ}
_OPERATOR = _VIEWER | {TASK_SUBMIT, TASK_CANCEL, TOOLS_EXECUTE, MEMORY_WRITE, POLICY_SYNC, RELEASE_PROMOTE}
_APPROVER = _VIEWER | {APPROVAL_DECIDE, RELEASE_PROMOTE}

...
(540 testes). A Fase 13 não é fase nova: é o fechamento das lacunas que o próprio
...
| 13 | Fechamento das lacunas | 🟡 | 10b, 12b, 8b e 9b entregues (anexos/botões; worker e pack; laboratório de avaliação; assinatura e quórum); 6b e 5b na fila |
